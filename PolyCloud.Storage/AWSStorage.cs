    ...
    public class AWSStorage : Storage
    {
        ...
        public override List<CloudFolder> ListFolders()
        {
            try
            {
                ...
                ListBucketsResponse response = StorageClient.ListBuckets();
                ...
                if (response != null && response.Buckets != null)
                {
                    foreach (S3Bucket bucket in response.Buckets)
                    {
                        ...
                        GetBucketLocationResponse GBLresponse = StorageClient.GetBucketLocation(GBLrequest);
        ...
        public override bool NewFolder(String bucket)
        {
            ...
            {
                this.Exception = null;
                this.StorageClient.PutBucket(bucket);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public override bool DeleteFile(String bucket, String file)
        {
            ...
            {
                this.Exception = null;
                this.StorageClient.DeleteObject(bucket, file);
                return true;
            }
            catch (Exception ex)
            {
